...
import left from './Images/download.svg'
...
class SSlider extends Component {
  ...
  render() {
    ...
    return (
      <section className=" min-vh-50 container pt-2 p-4 mt-lg-3 mt-xl-4 mt-xxl-5 pb-0 " style={{height:"auto", paddingBottom:"-20px"}}>
        <h2 className="text-center pt-2 fw-medium fs-1 fw-medium" style={{color:"#006EAB",fontFamily:"'Staatliches', cursive"}}>Why Choose Namrata & Tushar Traders </h2>
        ...
        <div className="row align-items-center py-1 mt-md-3 mt-lg-0" >
          <div className="col-md-6 col-xl-5 offset-xl-1"   style={{borderRadius:"15px",boxShadow:"rgba(9, 30, 66, 0.25) 0px 4px 8px -2px, rgba(9, 30, 66, 0.08) 0px 0px 0px 1px"}}>
              ...
              <Slider ref={this.slider1} {...sliderSettings}>
                ...
                <div className="mb-lg-4 p-2" key={2}>
                  <img
                    style={{ width: "100%" }}
                    className="d-block position-relative zindex-2 px-4 "
                    src="https://img.freepik.com/premium-vector/create-work-plans-schedules-grow-business_18660-338.jpg?size=626&ext=jpg"
                    alt="App screen"
                  />
                </div>
                {/* Item */}
          ...
          <div className="col-md-6 col-xl-5 offset-xl-1" >
            <div className="ps-md-4 ps-xl-0 pt-4" >
              {/* React Slick slider */}
              <Slider ref={this.slider2} {...sliderSettings}>
                <div className="p-2" key={1}>
                  ...
                  <p className="mb-0 text-justify fw-medium fs-6" style={{fontFamily:"'Roboto', sans-serif;"}}>
                ...
                <div className=" p-2" key={2}>
                  ...
                  <p className="mb-0 text-justify fw-medium fs-6">
                    Our experienced team can help you make informed decisions
                    about your cattle's diet based on their unique nutritional
                    requirements, ensuring they thrive.
                  </p>
                </div>
                ...
                <div className=" p-2" key={4}>
                  ...
                  <p className="mb-0 text-justify fw-medium fs-6">
                    We prioritize your satisfaction and offer personalized
                    customer service for inquiries, order assistance, and
                    recommendations. Our commitment to exceptional service is
                    aimed at building lasting relationships with valued
                    customers who trust our products.{" "}
                  </p>
                </div>
              </Slider>
